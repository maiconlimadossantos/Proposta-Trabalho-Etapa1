...
<div class="max-w-2xl mx-auto bg-gray-900 p-6 rounded-lg border border-gray-800">
    <h1 class="text-xl font-bold mb-5 text-purple-400">Cadastrar Novo Filme</h1>
    ...
    <form action="{{ route('movies.store') }}" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="diretor" required placeholder="Ex: Christopher Nolan" class="w-full bg-gray-950 border border-gray-700 rounded p-2 text-white focus:outline-none focus:border-purple-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4">
            <div>
                ...
                <input type="number" name="ano_lancamento" required min="1800" class="w-full bg-gray-950 border border-gray-700 rounded p-2 text-white focus:outline-none focus:border-purple-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-400 mb-1">Duração (hh:mm:ss)</label>
                <input type="text" name="duracao" required placeholder="02:10:00" class="w-full bg-gray-950 border border-gray-700 rounded p-2 text-white focus:outline-none focus:border-purple-500">
            </div>
            <div>
        ...
        <div>
            ...
            <input type="url" name="capa" placeholder="https://link-da-imagem.com/poster.jpg" class="w-full bg-gray-950 border border-gray-700 rounded p-2 text-white focus:outline-none focus:border-purple-500">
        </div>
        ...
        <div class="flex justify-end space-x-3 pt-4 border-t border-gray-800">
            ...
            <button type="submit" class="bg-purple-600 hover:bg-purple-700 px-4 py-2 rounded text-sm font-medium transition">Salvar Filme</button>
        </div>
    </form>
</div>
@endsection